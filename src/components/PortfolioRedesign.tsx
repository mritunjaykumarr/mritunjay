...
const socials = [
  ...
  { label: 'Email', href: 'mailto:mritunjaykumar2025@gmail.com', icon: Mail },
];
          ...
          <div className="v3-container v3-hero-grid">
            <FadeIn className="v3-hero-copy">
              ...
              <div className="v3-hero-actions">
                ...
                <a href="#contact" className="v3-button v3-button-quiet">Start a conversation <ArrowUpRight size={17} /></a>
              </div>
