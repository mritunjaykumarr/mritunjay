        ...
        <div className="container" style={{ maxWidth: 860 }}>
          <div style={{ padding: 'clamp(1.25rem, 3vw, 2rem)', marginBottom: '1.5rem', background: '#0a0a0a', border: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: '12px' }}>
            ...
            <p style={{ color: '#9a9a9a', lineHeight: 1.7, fontSize: '0.92rem' }}>
              mritify.online is the personal portfolio of <strong>Mritunjay Kumar</strong>, AI Engineer & Full Stack Developer based in Bihar / New Delhi, India. Contact: <a href="mailto:me@mritify.online" style={{ color: '#ffffff', textDecoration: 'underline' }}>me@mritify.online</a> and <a href="mailto:support@mritify.online" style={{ color: '#ffffff', textDecoration: 'underline' }}>support@mritify.online</a>. This site showcases engineering projects, technical skills, production experience, and software articles.
            </p>
          </div>
          ...
          <div style={{ padding: '2rem', background: '#0a0a0a', border: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: '12px' }}>
            ...
            <p style={{ color: '#9a9a9a', lineHeight: 1.7, fontSize: '0.92rem', margin: 0 }}>
              If you have any questions regarding privacy or data practices, please reach out via <a href="mailto:me@mritify.online" style={{ color: '#ffffff', textDecoration: 'underline' }}>me@mritify.online</a> or <a href="mailto:support@mritify.online" style={{ color: '#ffffff', textDecoration: 'underline' }}>support@mritify.online</a>.
            </p>
          </div>
        </div>
      </section>
